...
async function getsongs(folder) {
  ...
  for (const items of songs) {
    ...
    songul.innerHTML =
      songul.innerHTML +
      `<li>
          <img src="assets/img/music.svg" class="invert" alt="">
            <div class="info">
              <div>${items.replaceAll("%20", ' ')}</div>
                <div>Rahul</div>
              </div>
            <div class="playnow">
          <img src="assets/img/play.svg" class="invert" alt="">
        </div>
      </li>
      `;
  }
...
async function displayAlbum(){
  ...
  <img src="/assets/songs/${folder}/cover.jpg" alt="" srcset="">
  <h2>${resp.tittle}</h2>
...
async function main() {
  ...
  await getsongs(`assets/songs/ncs`);
  // console.log(song);
